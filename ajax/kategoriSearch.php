...
<?php
	...
	$totalDataEbook = count(tampil("SELECT*FROM ebook WHERE judulbuku LIKE '%$key%' AND kategori = '$kategori'"));
	...
	$dataebook1 = tampil("SELECT*FROM ebook WHERE judulbuku LIKE '%$key%' AND kategori = '$kategori' LIMIT $indexAwal,$jmlDataPerhalaman");
?>
