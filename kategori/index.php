<?php
	...
	$totalDataEbook = count(tampil("SELECT*FROM ebook WHERE kategori = '$kategori'"));
	...
	$dataebook1 = tampil("SELECT*FROM ebook WHERE kategori = '$kategori' ORDER BY id DESC LIMIT $indexAwal,$jmlDataPerhalaman");
